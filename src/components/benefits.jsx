...
const Benefits = () => {
    ...
    return (
        <div className='text-text_light mt-16 flex justify-between'>
            <div className=' px-32  h-[40vmax] text-3xl bg-black opacity-75 text-white pt-[-2vmax] md:flex-row flex-col w-[100%] gap-6'>
